 ...
 *
 */
public class SearchEngineSimilarityMain7 {
	...
	public static void main(String[] args) throws Exception {
		...
		BufferedReader daoj = new BufferedReader(new FileReader("gpcr230_keyword.txt"));
		...
		while(i <= high){
			...
			File file = new File(i + "_gpcr230.txt");
		    ...
		    PrintWriter pw_label=new PrintWriter(new FileOutputStream (i + "_gpcr230.txt"));
		    
			lineName = daoj.readLine();					
			System.out.println(lineName);			

			BufferedReader acm91 = new BufferedReader(new FileReader("gpcr230_keyword.txt"));
