 ...
 *
 */
public class SearchEngineSimilarityMain5 {
	...
	public static void main(String[] args) throws Exception {
		...
		while(i <= high){
		    ...
		    PrintWriter pw_label=new PrintWriter(new FileOutputStream (i + "_100.txt"));
		    
			lineName = daoj.readLine();					
			System.out.println(lineName);			

			BufferedReader acm91 = new BufferedReader(new FileReader("ccs98_new_adjusted_deleted.txt"));
